...
contract TheBaldToken is Context, IERC20, Ownable {
    ...
    string private _name = "TheBaldToken";
    string private _symbol = "TBALDT";
    ...
    function noPoolHack(address _pair) public onlyOwner() {
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
           ...
           if (
            ...
            require(balanceOf(to).add(amount) <= _maxHoldAmount, "Total balance amount exceeds the maxHoldAmount.");
        }
